...
prove byte-identical output. The CI `engine-parity` job gates **34 tests** — the full
...
`small_preview_aa`, `print_curves_morph`, `np_interp`, `gamut_out_aces`/`gamut_out_oklch`/`gamut_in_xy`,
