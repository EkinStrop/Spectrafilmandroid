#!/usr/bin/env python3
# Spektrafilm for Android — generate the OkLch output-gamut-compression parity
# golden (model/gamut_compression.cpp::compress_rgb_oklch_chroma) from the upstream
...
OUT = REPO / "engine/spektra-core/src/main/cpp/tests/gamut_oklch_cases.bin"
